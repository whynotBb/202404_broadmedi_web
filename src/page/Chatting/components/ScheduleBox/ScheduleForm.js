...
const ScheduleForm = () => {
    ...
    const categoryData = ['입국/출국', '진료/수술', '관광/쇼핑', '숙소/휴식'];
    return (
        <FormWrap>
            <div className='formItem col'>
                ...
                <input type='text' placeholder='제목을 입력해 주세요' className='titleInput' />
            </div>
            ...
            <div className='formItem col'>
                ...
                <LocationSelectBox placeholder='장소를 선택해 주세요.' optionData={locationData} />
            </div>
            <div className='formItem col'>
                <h5>
                    분류<em>*</em>
                </h5>
                <Dropdown size='w_100' placeholder='분류를 선택해 주세요.' optionData={categoryData} />
            </div>
