...
const ScheduleBox = ({close}) => {
    ...
    const handleDateClick = (arg) => {
        ...
        //     setCoordY(coordY - 160);
        // } else if (coordY > 400 && coordY < 560) {
        //     setCoordY(coordY - 310);
        // } else if (coordY > 560) {
        //     setCoordY(150);
        // }
        if (coordX > 580) {
    ...
    return (
        <div className='scheduleBoxWrap'>
            ...
            <div className='calendarWrap' onClick={handleClick}>
                <FullCalendar
                    locales={[koLocale]}
            ...
            <div className='customPositionModal' style={{top: '90px', left: coordX}}>
                <Modal
            ...
            <div className='customPositionModal' style={{top: coordY, left: coordX}}>
                <Modal
                    className={modalOpen2 ? 'open' : ''}
                    openModalHandler={modalCloseHandler2}
                    size='md'
                    type='noneDim'
                >
                    <ScheduleDetail />
