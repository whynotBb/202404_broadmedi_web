...
import { EstimateVisaAgencyForm } from "./EstimateVisaAgencyForm";
import ViewDocument from "./ViewDocument";

const EstimateVisaAgency = ({ viewHandler }) => {
  // 직접 추가한 서류 메뉴 여닫기
  ...
  return (
    <>
      <div className="chattingDrawerWrap">
        ...
        <div className="estimateWrap">
          <p className="fileName" onClick={openModalHandler4}>
            비자발급 대행 견적서_20231215비자발급 대행 견적서_20231215비자발급
            대행 견적서_20231215
          </p>
          <div className="dateTime">2023년 09월 30일 14:00</div>
      ...
      >
        ...
        <div class="modalScrollBox">
          <EstimateVisaAgencyForm />
          <div className="modalBottom">
      ...
      {/* 비자발급 대행 모달 : 결제 완료*/}
      <Modal
        className={openModal4 ? "open" : ""}
        openModalHandler={openModalHandler4}
      >
        <h3 className="modalTitle">비자발급 대행 견적서</h3>
        {/* ↓ exceptBtn : 스크롤 영역에 버튼을 제외시키는 경우 */}
        <div className="modalScrollBox exceptBtn">
...
export default EstimateVisaAgency;
