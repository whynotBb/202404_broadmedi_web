                    ...
                    <div className="contentsWrap">
                        ...
                        <div className="contentsBox">
                            <div className="contents">
                                남동현 기자 = 부산시가 운행하고 있는
                                의료·관광·복지 분야 특화버스가 시민들로부터 큰
                                호응을 얻고 있다.
                                <br />
                                <br />
                                특화버스는 취약지역·계층에 맞춤형 서비스 제공을
                                통해 정책 사각지대 해소와 함께 시민들의 실제
                                사례를 통한 정책 체감도 향상 및 정보 제공에 크게
                                이바지하고 있다.
                                <br />
                                <br />
                                시가 운영하고 있는 특화버스는 ▲찾아가는 의료버스
                                ▲전국 최초 관광형 수요응답형 버스 타바라 ▲전국
                                최초 장애인 시티투어버스 나래버스 등이다.
                            </div>
                        </div>
                    </div>
                </div>
