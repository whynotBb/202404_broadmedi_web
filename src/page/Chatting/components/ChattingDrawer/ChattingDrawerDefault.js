...
const ChattingDrawerDefault = ({ profileImg, nationImg, viewHandler }) => {
    return (
        <>
            ...
            <div className="drawerMenuWrap">
                <ul>
                    ...
                    <li onClick={() => viewHandler(3)}>일정</li>
                    <li onClick={() => viewHandler(4)}>건강차트 요청</li>
                    <li onClick={() => viewHandler(5)}>의료관광 견적서</li>
                    <li onClick={() => viewHandler(6)}>의료관광 추가 견적서</li>
                    <li onClick={() => viewHandler(7)}>비자발급 대행 견적서</li>
                    <li onClick={() => viewHandler(8)}>공유 서류함</li>
                    <li onClick={() => viewHandler(9)}>유치실적 보고서</li>
                </ul>
            </div>
